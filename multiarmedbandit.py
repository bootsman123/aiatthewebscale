...
from epsilongreedy import EpsilonGreedy as Policy
...
class MultiArmedBandit(object):
    ...
    def propose(self, context, price = None):
           ...
           self.adtype = self.adtypepPol.choose_arm(context, self.contexts, self.pages, self.scores)
